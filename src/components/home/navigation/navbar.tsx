                ...
                <div className="flex items-center justify-between h-full mx-auto md:max-w-screen-xl">
                    ...
                    <nav className="hidden md:block absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <ul className="flex items-center justify-center gap-8">
                            ...
                            <Link href="#" className="hover:text-foreground/80 text-sm">Developers</Link>
                            <Link href="#" className="hover:text-foreground/80 text-sm">Features & Update</Link>
                            <Link href="#" className="hover:text-foreground/80 text-sm">Learning Arena</Link>
                        </ul>
                    </nav>
