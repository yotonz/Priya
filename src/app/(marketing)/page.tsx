                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                                Sonata&apos;s customizable Advanced Ai assistant.
                            </h1>
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                Unleash the power of AI with Priya! Customize your AI assistant to fit your needs and turn your vision into reality with Sonata. Feel the future of AI at your fingertips!
                            </p>
                            <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                                <Link href="#" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none">
                                    <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                                        ✨ {"  "} Get Your Own AI Assistant – Unleash Innovation Now!
                                    </p>
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Three steps to build your personal Ai assistant
                        </h2>
                        <p className="text-muted-foreground mt-6">
                            Priya is in development with limited customization. Select options, request access, and your AI assistant will be on Teams once approved by Developers.
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            Discover the cutting-edge capabilities that make our AI assistant stand out. From seamless customization to robust security, unlock the full potential of our advanced technology.
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Discover the Ideal Plan for Your Needs
                        </h2>
                        <p className="text-muted-foreground mt-6">
                            Select the right plan for your needs and start exploring Priya, the advanced AI assistant. Unlock powerful features and enhance your productivity.
                        </p>
                    </div>
                </Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            Discover how Priya transforms businesses. Hear directly from users about their experiences and see how Priya makes a difference.
                        </p>
                    </div>
                </Container>
                <Container>
                    ...
                    <LampContainer>
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            ...
                            <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                                Build stunning Ai assistants with Priya&apos;s Cutom Models and LLMS.
                            </p>
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 rounded-lg lg:rounded-2xl border border-border/80 py-4 md:py-8">
                            <div className="flex flex-col items-start gap-4 w-full">
                                ...
                                <p className="text-base text-muted-foreground">
                                    Be up to date with everything about Priya Ai
                                </p>
                            </div>
